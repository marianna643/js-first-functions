...
function createDetailString(objectDetails){
  return "Het beroep van "+ objectDetails.firstName + " " + objectDetails.lastName + " is " + objectDetails.profession ;
}

const stringDetail = createDetailString({ firstName: 'Jan', lastName: 'Jansen', profession: 'docent'})
